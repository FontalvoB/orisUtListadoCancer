...
export const getActivityLogsPaginated = async (
  ...
  if (filters.module)
    countConstraints.push(where("module", "==", filters.module));
  if (filters.action)
    countConstraints.push(where("action", "==", filters.action));
  if (filters.userId)
    countConstraints.push(where("userId", "==", filters.userId));
  if (filters.userEmail)
    countConstraints.push(where("userEmail", "==", filters.userEmail));
